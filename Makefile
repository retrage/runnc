...
container-build:
	...
	sudo docker run --rm -v ${PWD}:/go/src/github.com/retrage/runnc -w /go/src/github.com/retrage/runnc runnc-build make

container-install:
	sudo docker build . -f Dockerfile.build -t runnc-build
	sudo docker run --rm -v /opt/runnc/:/opt/runnc/ -v /usr/local/bin:/usr/local/bin -v ${PWD}:/go/src/github.com/retrage/runnc -w /go/src/github.com/retrage/runnc runnc-build make install
